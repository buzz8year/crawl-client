...
class ParserStrategy
{
    ...
    public function runClientSession(string $url)
    {
        $this->url = $url;
        $method = SessionType::METHODS[$this->factory->client];
        return $this->{$method}();
    }
    ...
    public function fileSession()
    {
        ...
        {
            $this->handleResponse(0,  SessionType::FILE);
            return $contents;
        }
    }
    ...
    /**
     * phantomSession() function establishes a phantomjs-php session.
     *
     * @param string $url
     * @return array
     */
    public function phantomSession()
    {
        ...
        $this->handleResponse(0, SessionType::PHANTOM);
        
        // if (!$response->getContent() && $this->factory->proxies) {
        //     $this->processResponse(1, $this->url);
        //     return $this->phantomSession($this->url);
        // }
