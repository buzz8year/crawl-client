            ...
            <div class="form-group pull-right text-right text-muted">
                ...
                <?= Html::submitButton(
                        ...
                        [
                            ...
                            'title' => boolval($model->products) ? 'У вас есть результаты парсинга, которые ожидают команды к детализации' : '',
                        ]
                    ) 
                ?><br/><br/>
                <?php if ($syncData) : ?>
        ...
        <div class="col-md-4">
            ...
            <div id="categoryTree">
                ...
                <?php if ($model->categorySourceId > 0) {
                    ...
                    echo ParserProvisioner::displayNestedSelect($sourceCategories, $model->id, $model->regionId, $model->categorySourceId); 
                }?>
            ...
            <?= Html::input('text', 'flyKeyword', '', [
                    ...
                    'placeholder' => '...или введите новое и нажмите Enter',
