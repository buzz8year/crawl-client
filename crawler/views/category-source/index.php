    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'label'     => 'Parent',
                'content'   => function ($model) {
                    $category = \crawler\models\category\Category::find()->join('join', 'category_source cs', 'cs.category_id = category.id')->where(['cs.id' => $model->self_parent_id])->one();
                    return $category ? $category->title : '';
                },
                'filter'    =>  ArrayHelper::map( 
                    \crawler\models\category\Category::find()
