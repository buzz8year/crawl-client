...
<div class="row">
	<?php 
		foreach ($sources as $id => $source)
		{
			...
			echo '<br/><small class="text-muted">Товаров: ' . count(Source::findOne($id)->products) . '</small>';
			echo '<br/><small class="text-muted">Несинх.: ' . count(Source::findOne($id)->asyncProducts) . '</small></div>';
		} 
	?>
</div>