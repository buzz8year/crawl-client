    ...
    'columns'      => [
        ...
        [
            ...
            'value'     => function ($model) {
                return Html::a($model->url, $model->url, ['title' => $model->url, 'style' => 'width: 25vw; display: block; overflow: hidden']);
            },
        ],
        // 'source_id',
        [
        ...
        [
            ...
            'format'    => 'raw',
            'value'     => function ($model) {
                if ($category = CategorySource::findOne($model->category_source_id)) {
                    return Html::a(Category::findOne($category->category_id)->title, ['category/index', 'CategorySearch[id]' => $category->category_id]);
                }
            },
        ],
        // 'keyword_id',
